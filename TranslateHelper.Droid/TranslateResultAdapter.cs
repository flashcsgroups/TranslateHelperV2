...
namespace TranslateHelper.Droid
{
    ...
    public class TranslateResultAdapter : BaseAdapter<TranslateResult>
    {
        ...
        protected IList<TranslateResult> news = new List<TranslateResult>();

        public TranslateResultAdapter(Activity context, IList<TranslateResult> news)
            : base()
        {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            translatedTextView.SetText(news[position].TranslatedText, TextView.BufferType.Normal);
            transcriptionTextView.SetText(news[position].Ts, TextView.BufferType.Normal);
            posTextView.SetText(news[position].Pos, TextView.BufferType.Normal);
